...
def calculate_demographic_data(print_data=True):
    ...
    percentage_bachelors = round((df.education=="Bachelors").value_counts(normalize=True)[True]*100,1)
    ...
    higher_education_rich = round((higher_education.salary==">50K").value_counts(normalize=True)[True]*100,1)
    lower_education_rich = round((lower_education.salary==">50K").value_counts(normalize=True)[True]*100,1)
    ...
    rich_percentage = round((num_min_workers.salary==">50K").value_counts(normalize=True)[True]*100,1)
